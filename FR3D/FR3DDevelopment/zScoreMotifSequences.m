...
Name{3} = ['Basepairs using ' num2str(method) ', base-phosphates, and base-ribose'];
Name{4} = ['Basepairs using ' num2str(method) ', base-phosphates, base-ribse, and stacking'];
...
m = 4;
scores(:,4) = scores(:,3);                  % place to store all scores
