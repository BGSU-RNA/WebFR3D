% zScoreMotifVariants takes a set of nucleotides from a FR3D search, generates all possible sequence variants, and scores them according to various pairwise scoring schemes
