...
CurrentVersion = 7.2;                       % version number of class limits
...
B =    [  1    4.5  7.0  5.4  8.5 -3.0  3.0 -1.1 -0.7   45  100];  % cis WC-WC
...
B = [B;[ -4   -3.0 -0.2  7.0  9.2 -3.0  3.0 -1.1 -0.6  135  175]]; % tr   H-WC, expanded 2010-07-13
...
B = [B;[-11.0  5.7  7.7 -2.6 -0.0 -3.0  3.0 -1.1 -0.65 260  -40]]; % csS  Expanded 2010-12-01 CLZ
% B = [B;[-11.1  3.9  5.8 -3.6 -2.1 -3.0  3.0 -1.1 -0.65 225  -80]]; % csS but really out of plane and not a basepair
B = [B;[-11.1  5.8  7.3 -3.3 -2.6 -3.0  3.0 -1.1 -0.65 250  -50]]; % csS - Jesse 10_11_07, modified by CLZ 10-16-07
